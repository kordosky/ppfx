#ifndef ABSORPTIONREWEIGHTER_H
#define ABSORPTIONREWEIGHTER_H
...
namespace NeutrinoFluxReweight{
   ...
   */
  class AbsorptionReweighter : public IInteractionChainReweighting{
  public:  
    /*!
     ...
     */
    AbsorptionReweighter(int iuniv, const ParameterTable& cv_pars, const ParameterTable& univ_pars);
    virtual ~AbsorptionReweighter();
