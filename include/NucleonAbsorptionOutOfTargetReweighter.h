#ifndef NUCLEONABSORPTIONOUTOFTARGETREWEIGHTER_H
#define NUCLEONABSORPTIONOUTOFTARGETREWEIGHTER_H
...
namespace NeutrinoFluxReweight{
  ...
  /*! \class NucleonAbsorptionOutOfTargetReweighter
   *  \brief Reweight a MC survival probabiity when the particles through volumes
   */
  class NucleonAbsorptionOutOfTargetReweighter : public IInteractionChainReweighting{
  public:  
    /*!
