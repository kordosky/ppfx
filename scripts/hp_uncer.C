...
const int Ncorr = 10;  
const char* corr[Ncorr]  = {"pcpi","pck","ncpi","pcnu","mes","nua","att","abs","oth","tot"};
const char* fcorr[Ncorr] = {"ThinTargetpCPion","ThinTargetpCKaon","ThinTargetnCPion","ThinTargetpCNucleon",
			    "ThinTargetMesonIncident","ThinTargetnucleonA","TargetAttenuation","TotalAbsorption","Other","total"};
const int corr_col[Ncorr] = {4,4,kOrange+1,kOrange+1,43,43,3,3,38,1};

const int corr_sty[Ncorr] = {1,2,1,2,1,2,1,2,1,1};

const char* cleg[Ncorr]   = {"pC #rightarrow #piX","pC #rightarrow KX","nC #rightarrow #piX","pC #rightarrow nucleonX","meson inc.",
			     "nucleon-A","target att.","absorption","others","total HP"};
