...
namespace NeutrinoFluxReweight{
  ...
  AbsorptionDVOLReweighter::AbsorptionDVOLReweighter(int iuniv, const ParameterTable& cv_pars, const ParameterTable& univ_pars):iUniv(iuniv),cvPars(cv_pars),univPars(univ_pars){ 
