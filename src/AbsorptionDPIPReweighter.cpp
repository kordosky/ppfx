...
namespace NeutrinoFluxReweight{
  ...
  AbsorptionDPIPReweighter::AbsorptionDPIPReweighter(int iuniv, const ParameterTable& cv_pars, const ParameterTable& univ_pars):cvPars(cv_pars),univPars(univ_pars),iUniv(iuniv){ 
  ...
  std::vector<bool> AbsorptionDPIPReweighter::canReweight(const InteractionChainData& aa){
